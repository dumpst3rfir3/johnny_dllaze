> [!IMPORTANT]
> This README needs to be updated as some changes have been made. Stay tuned.
...
First, edit the versioninfo.template and versioninfo.json files in the goDLL and goEXE directories, if desired. You can add your own description, company/copyright info., etc.
